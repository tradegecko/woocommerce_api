...
describe WoocommerceAPI::Store do
  include_context "woocommerce_api_services", version: 'v3', use_cassette: 'store_v3' do
    it_behaves_like "a woocommerce store details", version: 'v3'
  end
end

describe WoocommerceAPI::Store do
  include_context "woocommerce_api_services", version: 'v2', use_cassette: 'store_v2' do
    it_behaves_like "a woocommerce store details", version: 'v2'
  end
end
